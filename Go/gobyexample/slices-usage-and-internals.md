...
A slice literal is declared just like an array literal, execpt leave out the element count
...
To append the slice to another slice, use ... to expand the second argument to a list of
arguments.
